...
export const GAME_DESIGN_CONFIG = {
  ...
  ui: {
    ...
    evolutionAnimTotalMs: 3600,
    evolutionAnimWhiteMs: 280,
    evolutionAnimFlashMs: 360,
    evolutionAnimRevealMs: 980,
    evolutionAnimBackdropFadeMs: 320,
    evolutionAnimSwapCount: 7,
    evolutionAnimParticleCount: 20,
