...
- Adding, changing, relocating, or removing active rules requires same-change updates to the canonical doc, [rule-registry.json](./rule-registry.json), and [rule-coverage.md](./rule-coverage.md). [RULE:AI-DOC-005]
