...
const STORY_ZONES = [
  ...
  dungeonZone("digletts_cave", "Cave Taupiqueur (Kanto)", "digletts-cave", "Kanto_Digletts_Cave_Map.png", { x: 44, y: 72 }),
  ...
  dungeonZone("rock_tunnel", "Grotte (Kanto)", "rock-tunnel", "Rock_Tunnel_1F_FRLG.png", { x: 75, y: 58 }),
  cityZone("lavender_town", "Lavanville (Kanto)", "lavender-town", "Lavender_Town_FRLG.png", { x: 74, y: 63 }),
  dungeonZone(
    "pokemon_tower",
    "Tour Pokemon (Kanto)",
    "pokemon-tower",
    "Pok\u00e9mon_Tower_FRLG.png",
    { x: 74, y: 63 },
  ),
