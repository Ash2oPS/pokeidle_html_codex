...
export function sanitizeGameDesignConfig(rawConfig = GAME_DESIGN_CONFIG) {
  ...
  const runtimeShellSource = isPlainObject(uiSource.runtimeShell) ? uiSource.runtimeShell : {};
  const defaultRuntimeShell = isPlainObject(defaults.ui.runtimeShell) ? defaults.ui.runtimeShell : {};
  ...
  const sanitized = {
    ...
    ui: {
      ...
      runtimeShell: {
        desktopTopbarHeightPx: readNumber(
          runtimeShellSource.desktopTopbarHeightPx,
          defaultRuntimeShell.desktopTopbarHeightPx,
          { min: 44, max: 320, integer: true },
        ),
        desktopDockHeightPx: readNumber(
          runtimeShellSource.desktopDockHeightPx,
          defaultRuntimeShell.desktopDockHeightPx,
          { min: 44, max: 240, integer: true },
        ),
        mobileTopbarHeightPx: readNumber(
          runtimeShellSource.mobileTopbarHeightPx,
          defaultRuntimeShell.mobileTopbarHeightPx,
          { min: 44, max: 320, integer: true },
        ),
        mobileDockHeightPx: readNumber(
          runtimeShellSource.mobileDockHeightPx,
          defaultRuntimeShell.mobileDockHeightPx,
          { min: 44, max: 240, integer: true },
        ),
      },
      modal: {
