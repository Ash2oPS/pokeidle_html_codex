...
export const EVOLUTION_ANIM_SWAP_COUNT = GAME_DESIGN.ui.evolutionAnimSwapCount;
...
export const HUD_UI_TOKENS = Object.freeze({
  ...GAME_DESIGN.ui.hud,
});
export const RUNTIME_SHELL_UI_TOKENS = Object.freeze({
  ...GAME_DESIGN.ui.runtimeShell,
});
export const MODAL_UI_TOKENS = Object.freeze({
  ...GAME_DESIGN.ui.modal,
});
export const ACTION_MENU_UI_TOKENS = Object.freeze({
  ...GAME_DESIGN.ui.actionMenu,
});
export const NOTIFICATION_UI_TOKENS = Object.freeze({
  ...GAME_DESIGN.ui.notification,
});
export const COLLECTION_LAYOUT_UI_TOKENS = Object.freeze({
  ...GAME_DESIGN.ui.collectionLayout,
});
export const MOBILE_SAFE_AREA_UI_TOKENS = Object.freeze({
  ...GAME_DESIGN.ui.mobileSafeArea,
});
