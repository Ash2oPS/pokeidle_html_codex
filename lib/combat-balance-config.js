...
export const PROJECTILE_SPEED_PX_PER_SECOND = 520;
export const PROJECTILE_TWEEN_DURATION_MIN_MS = 140;
export const PROJECTILE_TWEEN_DURATION_MAX_MS = 620;
...
export const KO_RESPAWN_DELAY_MS = 420;
export const KO_ANIMATION_DURATION_MS = 210;
